...
class Example(base, form):
    def __init__(self):
        ...
        self.webView.load(QUrl("http://rcs.lv"))
    ...
    # Notice how it also works when connected Radio Button 1 is toggled!
    def radioButton_2_slot(self):
        print('Radio Button Toggled!')

    def valuechange_slot(self):
        print(f'Slider Value: {self.horizontalSlider.value()}')
        self.mysliderLabel.setText(
            f'Slider Value: {self.horizontalSlider.value()}')
